...
if __name__ == "__main__":
    ...
    # 加载预训练权重
    pretrained_weights_path = '../weights/fasternet_t2-epoch.289-val_acc1.78.8860.pth'
    ...
    # 因为预训练模型可能与当前模型结构不完全匹配（例如类别数量不同），所以这里我们只加载那些形状匹配的参数
    ...
    # 创建一个随机输入张量，模拟一批次大小为2，通道数为3，宽度和高度均为224的图像数据
